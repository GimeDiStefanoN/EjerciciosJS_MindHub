...
// 1 Crea un bucle: FOR  → que recorra los datos de los diferentes objetos/ARRAYS que creaste en clases anteriores y observa en consola los datos que se obtienen de estos y cómo se representan.


// 1 Crea un bucle: FOR IN → que recorra los datos de los diferentes objetos/ARRAYS que creaste en clases anteriores y observa en consola los datos que se obtienen de estos y cómo se representan.


// 1 Crea un bucle: WHILE  → que recorra los datos de los diferentes objetos/ARRAYS que creaste en clases anteriores y observa en consola los datos que se obtienen de estos y cómo se representan.
